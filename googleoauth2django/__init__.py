...
Only Django versions 2.1.4+ are supported.
...
MIDDLEWARE should also contain the string:
...
.. code-block:: python
   ...
   from googleoauth2django.site import urls as oauth2_urls

   urlpatterns += [url(r'^oauth2/', oauth2_urls)]
...
.. code-block:: python
   ...
   from googleoauth2django.decorators import oauth_required
...
.. code-block:: python
   ...
   from googleoauth2django.decorators import oauth_enabled
...
.. code-block:: python
   ...
   from googleoauth2django.signals import oauth2_authorized
...
:class:`googleoauth2django.models.CredentialsField` with the name
...
from googleoauth2django import storage
from googleoauth2django.helpers import clientsecrets
...
def _get_storage_model():
    ...
    Returns:
        ...
        :class:`googleoauth2django.models.CredentialsField`
...
def get_oauth2_settings():
    return OAuth2Settings(django.conf.settings)
...
class UserOAuth2(object):
    ...
    def has_credentials(self):
        ...
        return (credentials is not None and credentials.valid is True and
    ...
    def http(self):
        ...
        if self.has_credentials():
            ...
            return OAuth2Session(client_id=self.credentials._client_id,
